<?php
/*
Plugin Name: Aspexi Facebook Like Box Slider
...
if ( !class_exists( 'AspexiFBlikebox' ) ) {
    ...
    define('ASPEXIFBLIKEBOX_VERSION', '2.1.12');
    ...
    class AspexiFBlikebox {
        ...
        public function admin_menu() {
            add_submenu_page( 'themes.php', __( 'Aspexi Facebook Like Box Slider', 'aspexifblikebox' ), __( 'Facebook Like Box Slider', 'aspexifblikebox' ), 'manage_options', basename(__FILE__), array( &$this, 'admin_page') );
        }
        ...
        public function admin_page() {
            ...
            ?>
            <div class="wrap">
                <div id="icon-link" class="icon32"></div><h2><?php _e( 'Aspexi Facebook Like Box Slider Settings', 'aspexifblikebox' ); ?></h2>
                ...
                <div id="poststuff" class="metabox-holder">
                    <div id="post-body">
                        <div id="post-body-content">
                                ...
                                <div class="postbox">
                                    ...
                                    <div class="inside">
                                        <table class="form-table">
                                            <tbody>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Page Plugin', 'aspexifblikebox'); ?></th>
                                            ...
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Page Plugin Height', 'aspexifblikebox'); ?></th>
                                                <td><input type="text" name="afblb_height" value="285" size="3" disabled readonly />&nbsp;px<?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Page Plugin Width', 'aspexifblikebox'); ?></th>
                                                <td><input type="text" name="afblb_width" value="245" size="3" disabled readonly />&nbsp;px<?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Adaptive Width', 'aspexifblikebox'); ?></th>
                                                <td><input type="checkbox" value="on" name="afblb_adaptive_width" disabled readonly/><?php echo $this->get_pro_link(); ?></td></td>
                                            </tr>
                                            <tr valign="top">
                                            ...
                                            <tr valign="top">
                                                <th scope="row">
                                                    <?php _e( 'Hide CTA', 'aspexifblikebox'); ?><br>
                                                    <span style="font-size: 10px;"><?php _e( 'Hide the custom call to action button (if available)', 'aspexifblikebox' ); ?></span>
                                                </th>
                                                <td><input type="checkbox" value="on" name="afbsb_cta" disabled readonly><?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Hide Cover', 'aspexifblikebox'); ?><br /><span style="font-size: 10px"><?php _e('Hide cover photo in the header.', 'aspexifblikebox'); ?></span></th>
                                                <td><input type="checkbox" value="on" name="afblb_header" disabled readonly /><?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Small Header', 'aspexifblikebox'); ?><br /><span style="font-size: 10px"><?php _e('Use the small header instead.', 'aspexifblikebox'); ?></span></th>
                                                <td><input type="checkbox" value="on" name="afblb_small_header" disabled readonly /><?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                            ...
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Don\'t show again', 'aspexifblikebox'); ?></th>
                                                <td><input type="checkbox" value="on" name="afblb_dont_show_again" disabled readonly/><?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row">
                                                    <?php _e('Slide out for unique users only', 'aspexifblikebox'); ?>
                                                    <div style="font-size: 10px"><?php _e('If you select this checkbox and enable auto slide out, this will happen only once for user', 'aspexifblikebox'); ?></div>
                                                </th>
                                                <td><input type="checkbox" value="on" name="afbsb_slide_out_unique" disabled readonly /><?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row">
                                                    <?php _e('Tabs', 'aspexifblikebox'); ?>
                                                </th>
                                                <td>
                                                    <label>
                                                    ...
                                                    <p><?php echo $this->get_pro_link(); ?></p>
                                                </td>
                                            </tr>
                                            <?php
                                    ...
                                    <div class="inside">
                                        <table class="form-table">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td><input type="radio" name="afblb_btvertical" value="top" disabled readonly />&nbsp;<?php _e('top of like box','aspexifblikebox'); ?><br />
                                                    <input type="radio" name="afblb_btvertical" value="middle" checked disabled readonly />&nbsp;<?php _e('middle of like box','aspexifblikebox'); ?><br />
                                                    <input type="radio" name="afblb_btvertical" value="bottom" disabled readonly />&nbsp;<?php _e('bottom of like box','aspexifblikebox'); ?><br />
                                    ...
                                    <div class="inside">
                                        <table class="form-table">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td><input type="radio" name="afblb_vertical" value="middle" checked disabled readonly />&nbsp;<?php _e('middle','aspexifblikebox'); ?><br />
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="checkbox" value="on" name="afblb_autoopen" disabled readonly /><?php echo $this->get_pro_link(); ?><br>
                                                    <?php _e('Auto open after', 'aspexifblikebox'); ?>&nbsp;<input type="text" name="afblb_autoopentime" value="400" size="3" disabled readonly />&nbsp;<?php _e('milliseconds', 'aspexifblikebox'); ?> (1000 milliseconds = 1 second)
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="checkbox" value="on" name="afblb_autoopen" disabled readonly /><?php echo $this->get_pro_link(); ?><br>
                                                    <?php _e('Auto close after', 'aspexifblikebox'); ?>&nbsp;<input type="text" name="afblb_autoopentime" value="400" size="3" disabled readonly />&nbsp;<?php _e('milliseconds', 'aspexifblikebox'); ?> (1000 milliseconds = 1 second)
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Auto open when user reaches bottom of the page', 'aspexifblikebox'); ?></th>
                                                <td><input type="checkbox" value="on" name="afblb_autoopenonbottom" disabled readonly /><?php echo $this->get_pro_link(); ?></td>
                                            </tr>
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    ...
                                                    <?php echo __( 'Auto open when user is', 'aspexifblikebox' ); ?>:&nbsp;<input type="text" disabled readonly name="afblb_autoopenonposition_px" size="5">px&nbsp;from:
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    ...
                                                    <?php echo __( 'Auto open when user reaches', 'aspexifblikebox' ); ?>:&nbsp;<input type="text" disabled readonly name="afblb_autoopenonelement_name" size="10" value=""><small><?php echo __( '(jQuery selector for example #element_id, .some_class)', 'aspexifblikebox' ); ?></small><br>
                                                    <?php echo $this->get_pro_link(); ?>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="text" name="afblb_disabled_on_ids" value="" disabled readonly /><?php echo $this->get_pro_link(); ?>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Disable on Posts:', 'aspexifblikebox'); ?></th>
                                                <td>
                                                    <input type="checkbox" value="on" name="afblb_disabled_on_posts" disabled readonly /><?php echo $this->get_pro_link(); ?>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <th scope="row"><?php _e('Disable on all Pages:', 'aspexifblikebox'); ?></th>
                                                <td>
                                                    <input type="checkbox" value="on" name="afblb_disabled_on_pages" disabled readonly /><?php echo $this->get_pro_link(); ?>
                                                </td>
                                            </tr>
                                            <?php
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    ...
                                                    foreach ($types as $post_type) {
                                                        echo '<input type="checkbox" value="' . $post_type . '" name="afblb_disabled_on_posttypes[]" disabled readonly /> ' . $post_type . '<br>';
                                                    }
                                                    ?>
                                                    <?php echo $this->get_pro_link(); ?>
                                                </td>
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <input type="checkbox" value="on" name="afblb_disabled_on_archives" disabled readonly /><?php echo $this->get_pro_link(); ?>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                            ...
                            <div id="aspexifblikebox-footer" style="text-align:left;text-shadow:0 1px 0 #fff;margin:0 0 10px;color:#888;"><?php echo sprintf(__('If you like %s please leave us a %s rating. A huge thank you in advance!'), '<strong>Aspexi Facebook Like Box Slider HD</strong>', '<a href="https://wordpress.org/support/plugin/aspexi-facebook-like-box/reviews/#new-post" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733</a>') ?></div>
        ...
        public function get_html( $preview = false ) {
            ...
            <script>(function(d, s, id) {
                ...
                js.src = "//connect.facebook.net/'.$locale.'/sdk.js#xfbml=1&version=v2.12&appId=1548213832159053";
            ...
            <div class="aspexifblikebox">
                ...
                <div class="aspexi_facebook_iframe">
                    <div class="fb-page" data-href="'.$page_url.'" data-width="'.($width - 4).'" data-height="'.($height - 4).'" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="'.$page_url.'"><a href="'.$page_url.'">Facebook</a></blockquote></div></div>
                </div>
            </div>';
    ...
    <td><input type="checkbox" value="on" name="afblb_polylang" disabled readonly />'.$this->get_pro_link().'</td>
        ...
        ?>
            <div class="notice notice-success" id="afblnotice" style="display: flex;flex-wrap: wrap;">
                <p><?php _e( 'Is your site secure? Check out how can you protect your website with <a href="https://asecure.me/?utm_source=likeboxfree" target="_blank">ASecure.me</a> services.', 'aspexifblikebox' ); ?>
                    <div style="flex: 1 300px;margin: .5em 0;text-align: right;">
                        <input type="button" id="afblhidenotice" value="<?php _e( 'Hide this notice', 'aspexifblikebox' ); ?>" class="button" />
                        <input type="button" value="<?php _e( 'Visit ASecure.me', 'aspexifblikebox' ); ?>" onclick="window.open('https://asecure.me/?utm_source=likeboxfree');" class="button-primary" />
                    </div>
                </p>
            </div>
        <?php
